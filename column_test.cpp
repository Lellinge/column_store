...
TEST(COLUMN, BASIC_INSERT) {
    column::Column<std::int64_t> test_colum("score");
...
TEST(COLUMN, DOUBLE_BASIC_INSERT) {
    column::Column<double> test_colum("double");
...
TEST(COLUMN, FLOAT_BASIC_INSERT) {
    column::Column<float> test_colum("float");
...
TEST(COLUMN, FLOAT_INSERT_AND_READ_BACK) {
    ...
    column::read_all(test_colum);
}

TEST(COLUMN, INT_BASIC_INSERT) {
    column::Column<int> test_colum("int");
...
TEST(COLUMN, CHAR_BASIC_INSERT) {
    column::Column<char> test_colum("char");
...
TEST(COLUMN, CHAR_READ_ALL) {
    column::Column<char> test_column("char");
...
TEST(COLUMN, CHAR_INSERT_AND_READ_BACK) {
    ...
    value = column::read_value(test_colum, row_id);
    EXPECT_EQ(value, 43);
}
